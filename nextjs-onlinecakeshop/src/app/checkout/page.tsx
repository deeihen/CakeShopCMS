    ...
    <div className="min-h-screen bg-[#FFF8F0]">
      ...
      <section className="relative bg-[#FFF0F5] overflow-hidden py-16">
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-6">
          ...
          <div className="inline-flex items-center gap-2 bg-white border border-[#F4A7B9] text-[#C2185B] text-xs font-semibold tracking-widest uppercase px-4 py-2 rounded-full shadow-sm mb-4 ml-4">
            <span className="w-2 h-2 rounded-full bg-[#F4A7B9] inline-block" />
            Almost There
          </div>
