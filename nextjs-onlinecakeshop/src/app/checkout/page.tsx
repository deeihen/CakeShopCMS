    ...
    return (
      <div className="min-h-screen bg-[#FFF8F0] flex items-center justify-center">
        <div className="text-center max-w-md mx-auto px-4">
          <div className="text-8xl mb-6">🎉</div>
          <h2 className="font-playfair text-4xl font-bold text-[#5C3D2E] mb-4">Order Placed!</h2>
          <p className="text-gray-500 leading-relaxed mb-8">
            Thank you! We've sent a confirmation to <strong>{form.email}</strong>. 
            We'll reach out shortly to confirm your order and send payment instructions.
          </p>
          <div className="card p-6 mb-8 text-left space-y-3">
            ...
            {[
              ...
              '3. We send you payment instructions',
            ...
            <div className="card p-6">
              ...
              <div className="space-y-4">
                {[
                  ...
                  { name: 'phone', label: 'Phone Number *', placeholder: '+63 912 345 6789', type: 'tel' },
          ...
          <div>
            <div className="card p-6 sticky top-24">
                    ...
                    <div key={i} className="flex items-center gap-3">
                      {src ? (
                        <div className="relative w-14 h-14 rounded-xl overflow-hidden flex-shrink-0">
                          <Image src={src} alt={item.product.name} fill sizes="56px" className="object-cover" />
                        </div>
                      ) : (
              ...
              <button
                ...
                disabled={loading}
                className="w-full bg-[#F4A7B9] text-white py-4 rounded-full font-semibold hover:bg-[#E8849A] transition-colors text-lg disabled:opacity-60 disabled:cursor-not-allowed">
                {loading ? 'Sending Order...' : 'Place Order via Email 📧'}
              </button>
